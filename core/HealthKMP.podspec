Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/HealthKMP.framework') || Dir.empty?('build/cocoapods/framework/HealthKMP.framework')
        raise "

        Kotlin framework 'HealthKMP' doesn't exist yet, so a proper Xcode project can't be generated.
